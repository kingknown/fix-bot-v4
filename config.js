...
global.sig = 'https://instagram.com/znxphoenix'' // ig
...
global.plinkaja = 'chatowner' //link aja
global.ppulsa = 'chatowner' //telkomsel
global.ppulsa2 = 'chatowner' // kalau ada kartu lain isi aja
...
/*============== WATERMARK ==============*/
global.wm = '                「 KingBotz 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘KingBotz ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ KingBotz '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By KingBotz`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 KingBotz  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'KingBotz'
global.stickauth = `By ©KingBotz`
